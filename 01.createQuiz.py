...
viết tóm tắt chức năng cho code dưới đây ở đầu code để refer đến: import streamlit as st
...
Dưới đây là đoạn code của bạn đã được chèn phần tóm tắt chức năng (docstring) ở ngay đầu file theo định dạng chuẩn, ngắn gọn và tường minh để bạn dễ dàng quản lý hoặc chia sẻ:

Python
"""
==========================================================================================
ỨNG DỤNG: Edu-Stay AI Quiz Platform (Hệ thống Học tiếng Anh Nghe hiểu)
CHỨC NĂNG CHÍNH:
1. Xác thực người dùng: 
   - Đăng nhập qua Google OAuth2 (Gmail).
   - Tự động giải mã JWT để lấy thông tin profile và đồng bộ (upsert) vào Database Supabase.
2. Trích xuất âm thanh (Scraping):
   - Cào dữ liệu từ link Apple Podcast để lấy URL file âm thanh gốc (.mp3/.m4a).
3. Xử lý Trí tuệ nhân tạo (Groq Cloud AI):
   - Chuyển đổi giọng nói thành văn bản (Speech-to-Text) bằng model Whisper-large-v3.
   - Tự động biên soạn đề trắc nghiệm 10 câu (định dạng JSON) bằng model Llama-3.1-8b-instant.
4. Giao diện & Tương tác (Streamlit):
   - Hiển thị bài đọc (Transcript), bộ câu hỏi trắc nghiệm.
   - Chấm điểm tự động và hiển thị giải thích chi tiết bằng tiếng Việt khi bấm nộp bài.
==========================================================================================
"""
