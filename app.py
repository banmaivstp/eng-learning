...
# =====================================================
# TẦNG STYLE: Import CSS theo từng màn riêng biệt
# - Global CSS (Login, layout nền): views/styles.py
# - Sidebar CSS: views/sidebar_css.py  ← TÁCH ĐỘC LẬP
# - Dashboard, Podcast, ShowList CSS: views/styles.py (chưa tách)
# =====================================================
...
# --- INJECT SIDEBAR CSS (Gen Z UI - Milestone 1) — từ views/sidebar_css.py ---
inject_sidebar_css()
